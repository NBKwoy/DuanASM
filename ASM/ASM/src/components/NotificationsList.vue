            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4">
                    ...
                    <div class="card-body">
                        ...
                        <div v-for="noti in notifications" :key="noti.id" class="d-flex align-items-start p-3 mb-2 rounded" style="transition: background-color 0.2s;" @mouseenter="$event.currentTarget.style.backgroundColor='#f8f9fa'" @mouseleave="$event.currentTarget.style.backgroundColor=''">

...
const handleAddComment = () => {
    if (props.post && props.post.newComment) {
            ...
            <div class="modal-content" @click.stop>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-between text-muted border-top border-bottom py-3 my-3">
                        <button @click="handleLike" class="btn flex-grow-1 border-0 fw-bold" :class="isLiked ? 'text-primary' : 'text-muted'">
                        ...
                        <button @click="handleShare" class="btn btn-light flex-grow-1 border-0 text-muted fw-bold">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        ...
                        <div class="input-group flex-grow-1">
                            ...
                            <button @click="handleAddComment" class="btn btn-primary rounded-pill px-4">
